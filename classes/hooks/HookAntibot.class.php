...
class PluginAntibot_HookAntibot extends Hook {
    ...
    protected function _init() {
        ...
        if (Config::Get('plugin.antibot.js')) {
            ...
            $this->Session_Set('plugin.antibot.fake_login', serialize($aInputSets));
        }
    }
    ...
    public function TplHtmlHeadEnd() {
        ...
        if (Config::Get('plugin.antibot.enable') && Config::Get('plugin.antibot.js')) {
            if ($sSessData = $this->Session_Get('plugin.antibot.fake_login')) {
    ...
    public function InitAction() {
        ...
        if (Config::Get('plugin.antibot.enable')) {
            if (in_array(Router::GetAction(), array('login', 'registration')) && isset($_POST['login'])) {
